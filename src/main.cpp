...
private:
    ...
    void updateUniformBuffer(uint32_t currentImage)
    {
        ...
        ubo.model = glm::rotate(
            ubo.model, time * glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        ubo.view = glm::lookAt(
            glm::vec3(0.5f, 0.5f, 2.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
    ...
    void createTextureImage()
    {
        ...
        stbi_uc *pixels = stbi_load(
            "assets/textures/texture.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
    {
        ...
        VkBuffer vertextBuffers[] = {vertexBuffer};
        VkDeviceSize offsets[] = {0};
        vkCmdBindVertexBuffers(commandBuffer, 0, 1, vertextBuffers, offsets);
    ...
    void createGraphicsPipeline()
    {
        ...
        // viewports and scissors, statically
        // VkViewport viewport{};
        // viewport.x = 0.0f;
        // viewport.y = 0.0f;
        ...
        // viewports and scissors, dynamically
